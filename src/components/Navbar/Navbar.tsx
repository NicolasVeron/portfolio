   ...
   return (
      <nav className={s.nav} style={{ height: "90px" }}>
         <a style={{ display: "flex", padding: "2px 5px", height: "100%", width: "100%", maxHeight: "90px" }}>
            <img src="/images/japtext.gif" alt="icon" style={{ height: "auto", maxWidth: "100%", objectFit: "contain", objectPosition: "left" }} />
         </a>
         <div></div>
         ...
         <div className={s.mobile} onClick={() => handleDisplay()}>
            <i className={active ? "fas fa-times" : "fas fa-bars"}></i> {/* bars: 28 x 32 */}
         </div>
      </nav>
   )
}
